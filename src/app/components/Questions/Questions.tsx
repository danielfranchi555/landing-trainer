...
export const Questions = () => {
  return (
    <div className="mx-auto max-w-7xl px-6 grid gap-4 mt-10 text-center md:px-0">
      <h3 className="font-bold text-5xl text-white">
        Commonly Asked Questions
      </h3>
      <span className="text-[#909090]">I am here to help!</span>
      <Accordion className="text-white max-w-max" type="single" collapsible>
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-2xl md:text-4xl font-bold">
            ¿Necesito tener experiencia previa para empezar a jugar al pádel?
          </AccordionTrigger>
          <AccordionContent className="text-[#909090] text-1xl md:text-2xl text-left">
