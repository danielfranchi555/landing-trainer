...
export const CallToAction = () => {
  return (
    <motion.div
      className="mt-50 shadow-md shadow-accent-foreground  bg-[#0D0D0D] text-white w-full md:max-w-7xl mx-auto flex  items-center flex-col gap-4 md:gap-6 xl:px-4 md:flex-row md:justify-between p-8 rounded-md"
      variants={containerVariants}
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true, amount: 0.3 }}
    >
      <p className="font-bold text-center md:text-start md:text-2xl xl:3xl ">
